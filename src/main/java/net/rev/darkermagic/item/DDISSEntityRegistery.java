...
public class DDISSEntityRegistery {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SummonedWarden>> SUMMONED_WARDEN = ENTITIES.register("summoned_warden", () -> EntityType.Builder.of(SummonedWarden::new, MobCategory.MONSTER).sized(0.9F, 2.9F).clientTrackingRange(64).build(ResourceLocation.fromNamespaceAndPath(DarkerMagic.MODID, "summoned_warden").toString()));
