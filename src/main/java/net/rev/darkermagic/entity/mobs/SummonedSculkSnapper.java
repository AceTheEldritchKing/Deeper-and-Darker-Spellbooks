...
public class SummonedSculkSnapper extends SculkSnapper implements IMagicSummon {
    public SummonedSculkSnapper(EntityType<SummonedSculkSnapper> type, Level Level) {
        super(type, Level);
        this.xpReward = 0;
    }
